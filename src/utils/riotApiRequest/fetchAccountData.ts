 ...
 * @param {string} gameName - The in-game name of the player.
 * @param {string} tagLine - The tagline associated with the player's Riot ID.
 * @returns {Promise<AccountDetails>} A promise that resolves to the account data in JSON format.
 *
 * @throws {Error} Throws an error if the fetch request fails.
 */
export async function fetchAccountData(region: string, gameName: string, tagLine: string): Promise<AccountDetails> {
