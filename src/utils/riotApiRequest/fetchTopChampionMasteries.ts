...
import {RawChampionMastery} from "@/types/RawInterfaces";
 ...
 */
export async function fetchTopChampionMasteries(server: string, puuid: string, count: number = 10): Promise<RawChampionMastery[]> {
    try {
